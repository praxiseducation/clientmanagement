/**
 * New Client Dialog Module - Enterprise sidebar integration
 * Features: Modern UI, form validation, loading states, backend integration
 */
...
(function() {
  ...
  const Templates = {
            ...
            <div class="container">
              ...
              <div id="actualForm" style="display: none;">
                ...
                <div class="form-section">
                  ...
                  <div class="service-selection">
                    ...
                    <div class="service-options">
                      <div class="service-checkbox act" onclick="NewClientDialog.toggleService(this, 'ACT')">
                        <input type="checkbox" id="service-act" value="ACT">
                        <label for="service-act">ACT</label>
                      </div>
                      <div class="service-checkbox math" onclick="NewClientDialog.toggleService(this, 'Math Curriculum')">
                        <input type="checkbox" id="service-math" value="Math Curriculum">
                        <label for="service-math">Math Curriculum</label>
                      </div>
                      <div class="service-checkbox language" onclick="NewClientDialog.toggleService(this, 'Language')">
                ...
                <div class="button-group">
                  <button class="btn-primary" onclick="NewClientDialog.processClient()">Create Client</button>
                  <button class="btn-secondary" onclick="NewClientDialog.close()">Cancel</button>
                </div>
    ...
    getDialogScript() {
      return `
        // Dialog-specific JavaScript
        window.NewClientDialog = {
          ...
          processClient: function() {
            ...
            const clientData = {
              ...
              services: this.getSelectedServices().join(', '),
          ...
          onFailure: function(error) {
            ...
            const button = document.querySelector('.btn-primary');
            NewClientDialog.setButtonLoading(button, false);
  ...
  // Public API
  const NewClientDialogAPI = {
    show() {
      const htmlOutput = HtmlService.createHtmlOutput(Templates.getDialogHTML())
  ...
  if (typeof global !== 'undefined') {
    global.NewClientDialog = NewClientDialogAPI;
  }
